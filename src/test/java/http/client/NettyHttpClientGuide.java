 ...
 **/
@Slf4j
public class NettyHttpClientGuide extends NettyGuideAbstract {
    ...
    public static ProjectAbstract getProject(String projectCode) {
        return NettyHttpClientGuide.PROJECT_MAP.get(projectCode);
    }

    public static void putProject(ProjectAbstract project) {
        NettyHttpClientGuide.PROJECT_MAP.put(project.getProjectCode(), project);
    }
