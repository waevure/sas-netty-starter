 ...
 **/
@Slf4j
public class NettyHttpServerGuide extends NettyGuideAbstract {
    ...
    public static ProjectAbstract getProject(String projectCode) {
        return NettyHttpServerGuide.PROJECT_MAP.get(projectCode);
    }

    public static void putProject(ProjectAbstract project) {
        NettyHttpServerGuide.PROJECT_MAP.put(project.getProjectCode(), project);
    }
