 ...
 **/
@Slf4j
public class NettyUdpServerGuide extends NettyGuideAbstract {
    ...
    public static ProjectAbstract getProject(String projectCode) {
        return NettyUdpServerGuide.PROJECT_MAP.get(projectCode);
    }

    public static void putProject(ProjectAbstract project) {
        NettyUdpServerGuide.PROJECT_MAP.put(project.getProjectCode(), project);
    }
