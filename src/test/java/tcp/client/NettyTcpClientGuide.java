 ...
 **/
@Slf4j
public class NettyTcpClientGuide extends NettyGuideAbstract {
    ...
    public static ProjectAbstract getProject(String projectCode) {
        return NettyTcpClientGuide.PROJECT_MAP.get(projectCode);
    }

    public static void putProject(ProjectAbstract project) {
        NettyTcpClientGuide.PROJECT_MAP.put(project.getProjectCode(), project);
    }
