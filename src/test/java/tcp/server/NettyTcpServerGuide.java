 ...
 **/
@Slf4j
public class NettyTcpServerGuide extends NettyGuideAbstract {
    ...
    public static ProjectAbstract getProject(String projectCode) {
        return NettyTcpServerGuide.PROJECT_MAP.get(projectCode);
    }

    public static void putProject(ProjectAbstract project) {
        NettyTcpServerGuide.PROJECT_MAP.put(project.getProjectCode(), project);
    }
