 ...
 **/
@Slf4j
public class NettyNoNetworkGuide extends NettyGuideAbstract {
    ...
    public static ProjectAbstract getProject(String projectCode) {
        return NettyNoNetworkGuide.PROJECT_MAP.get(projectCode);
    }

    public static void putProject(ProjectAbstract project) {
        NettyNoNetworkGuide.PROJECT_MAP.put(project.getProjectCode(), project);
    }
