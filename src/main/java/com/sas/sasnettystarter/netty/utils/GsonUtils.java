package com.sas.sasnettystarter.netty.utils;
...
public class GsonUtils {
    ...
    public static Map<String, Object> toJavaMap(Object object) {
        return toJavaObject(toString(object), new TypeToken<Map<String, Object>>(){}.getType());
    }
